...
/// Enables control over a single [ExpansionTileV2]'s expanded/collapsed state.
///
/// It can be useful to expand or collapse an [ExpansionTileV2]
/// programatically, for example to reconfigure an existing expansion
/// tile based on a system event. To do so, create an [ExpansionTileV2]
...
/// the [ExpansionTileV2] to rebuild, so they may not be called from
/// a build method.
class ExpansionTileController {
  /// Create a controller to be used with [ExpansionTileV2.controller].
  ExpansionTileController();

  _ExpansionTileV2State? _state;

  /// Whether the [ExpansionTileV2] built with this controller is in expanded state.
  ///
  ...
  /// See also:
  ///
  ///  * [expand], which expands the [ExpansionTileV2].
  ///  * [collapse], which collapses the [ExpansionTileV2].
  ///  * [ExpansionTileV2.controller] to create an ExpansionTile with a controller.
  bool get isExpanded {
    assert(_state != null);
    return _state!._isExpanded;
  }

  /// Expands the [ExpansionTileV2] that was built with this controller;
  ///
  ...
  ///
  /// Calling this method may cause the [ExpansionTileV2] to rebuild, so it may
  /// not be called from a build method.
  ///
  /// Calling this method will trigger an [ExpansionTileV2.onExpansionChanged] callback.
  ///
  /// See also:
  ///
  ...
  /// Collapses the [ExpansionTileV2] that was built with this controller.
  ///
  ...
  /// Finds the [ExpansionTileController] for the closest [ExpansionTileV2] instance
  /// that encloses the given context.
  ///
  /// If no [ExpansionTileV2] encloses the given context, calling this
  /// method will cause an assert in debug mode, and throw an
  /// exception in release mode.
  ///
  /// To return null if there is no [ExpansionTileV2] use [maybeOf] instead.
  ///
  /// {@tool dartpad}
  /// Typical usage of the [ExpansionTileController.of] function is to call it from within the
  /// `build` method of a descendant of an [ExpansionTileV2].
  ///
  /// When the [ExpansionTileV2] is actually created in the same `build`
  ...
  /// would have an outer widget that creates the [ExpansionTileV2]
  ...
  static ExpansionTileController of(BuildContext context) {
    final _ExpansionTileV2State? result =
        context.findAncestorStateOfType<_ExpansionTileV2State>();
    if (result != null) {
  ...
  /// Finds the [ExpansionTileV2] from the closest instance of this class that
  /// encloses the given context and returns its [ExpansionTileController].
  ///
  /// If no [ExpansionTileV2] encloses the given context then return null.
  /// To throw an exception instead, use [of] instead of this function.
  ///
  /// See also:
  ///
  ///  * [of], a similar function to this one that throws if no [ExpansionTileV2]
  ///    encloses the given context. Also includes some sample code in its
  ///    documentation.
  static ExpansionTileController? maybeOf(BuildContext context) {
    return context
        .findAncestorStateOfType<_ExpansionTileV2State>()
        ?._tileController;
  }
}
...
/// [ExpansionTileV2] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ExpansionTileV2].
///
/// {@tool dartpad}
/// This example demonstrates how the [ExpansionTileV2] icon's location and appearance
/// can be customized.
///
...
/// programatically expand or collapse an [ExpansionTileV2].
///
/// ** See code in examples/api/lib/material/expansion_tile/expansion_tile.1.dart **
/// {@end-tool}
///
...
class ExpansionTileV2 extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionTileV2({
    super.key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<ExpansionTileV2> createState() => _ExpansionTileV2State();
}

class _ExpansionTileV2State extends State<ExpansionTileV2>
